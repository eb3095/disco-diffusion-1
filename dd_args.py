...
def parse(a=None):
    ...
    parser.add_argument("--voronoi_palette", help="Voronoi Palette File", default=gp("voronoi_palette", "default.yaml"), required=False)
    parser.add_argument("--voronoi_palette_embed", type=str2json, help="Voronoi Palette (Will override voronoi_palette", default=gp("voronoi_palette_embed", None), required=False)
